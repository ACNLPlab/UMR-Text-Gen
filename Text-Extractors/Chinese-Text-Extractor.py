...
def sentence_extractor(file, output):
    keyword = "# :: snt"
    with open(file, "r", encoding="utf-8") as infile, open(output, "w", encoding="utf-8") as outfile:
            for line in infile:
                if keyword in line:
...
def first_combine(sentence_file, sentence_UMR_file, output_file):
    with open(sentence_file, "r", encoding="utf-8") as infile1, open(sentence_UMR_file, "r", encoding="utf-8") as infile2, open(output_file, "w", encoding="utf-8") as outfile:
...
def all_combine(sentence_file, sentence_UMR_file, alignment_file, document_level_file, output_file):
    with open(sentence_file, "r", encoding="utf-8") as infile1, open(sentence_UMR_file, "r", encoding="utf-8") as infile2, open(alignment_file, "r", encoding="utf-8") as infile3, open(document_level_file, "r", encoding="utf-8") as infile4, open(output_file, "w", encoding="utf-8") as outfile:
        sentences = infile1.readlines()
        umr_graphs = infile2.readlines()
