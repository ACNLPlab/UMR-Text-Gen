        ...
        for file_path in file_paths:
            ...
            with open(file_path, 'r', encoding='utf-8') as file:
                ...
                for line in lines:
                    ...
                    # Copy source line as is
                    if line.startswith('# ::source'):
                        combined_lines.append(line)
                        
                    # Update sentence number
                    elif line.startswith('# ::nsent'):
                        current_sent_num += 1
...
if __name__ == "__main__":
    input_files = [
        "eng_zho_sent_train_spring.txt",
        "arp_sent_train_spring.txt",
        "nav_sent_train_spring.txt",
        "saa_sent_train_spring.txt",
        "kuk_sent_train_spring.txt",
    ]
    output_file = "all_sent_train_spring.txt"
