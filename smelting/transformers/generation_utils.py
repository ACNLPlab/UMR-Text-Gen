...
class GenerationMixin:
    ...
    def _prepare_encoder_decoder_kwargs_for_generation(
        ...
        encoder_kwargs = {
            argument: value for argument, value in model_kwargs.items() if not argument.startswith("decoder_")  and argument != "type_data"
        }
    ...
    def generate(
        ...
        **model_kwargs,
        ...
        #model_kwargs["type_data"] = type_data
    ...
    def greedy_search(
        ...
        **model_kwargs,
        ...
        while cur_len < max_length:
            ...
            #model_inputs["type_data"] = type_data
    ...
    def beam_search(
        ...
        **model_kwargs,
        ...
        while cur_len < max_length:
            ...
            #model_inputs["type_data"] = model_kwargs["type_data"]
            outputs = self(
                **model_inputs,
                return_dict=True,
                output_attentions=output_attentions,
